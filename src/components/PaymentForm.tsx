...
import {
  ...
  ApiValidationError,
  PaymentMethod,
} from "@/lib/services/registersApi";
import {
  setNameError,
  setPhoneError,
  setEmailError,
...
} from "@/lib/services/invitationsApi";
...
import {
  ContenTiendasAfiliadas,
  HeaderTiendasAfiliadas,
} from "./ModalPayments";
...
const PaymentForm: React.FC<PaymentFormProps> = React.memo(
  ({ invitationId }) => {
    ...
    const [
      register,
      { isLoading: registerIsLoading, error: registerError, isSuccess },
    ] = useRegisterMutation();
    const [
      initialPayment,
      { isLoading: initialPaymentIsLoading, error: initialPaymentError },
    ] = useInitialPaymentMutation();
    ...
    const [tokuIframeCashReference, setTokuIframeCashReference] = useState("");
    ...
    const images = [
      "https://inphonity.com/stores/image1.png",
      "https://inphonity.com/stores/image2.png",
      "https://inphonity.com/stores/image3.png",
      "https://inphonity.com/stores/image4.png",
      "https://inphonity.com/stores/image5.png",
      "https://inphonity.com/stores/image6.png",
      "https://inphonity.com/stores/image7.png",
      "https://inphonity.com/stores/image8.png",
      "https://inphonity.com/stores/image9.png",
      "https://inphonity.com/stores/image10.png",
      "https://inphonity.com/stores/image11.png",
      "https://inphonity.com/stores/image12.png",
      "https://inphonity.com/stores/image13.png",
      "https://inphonity.com/stores/image14.png",
      "https://inphonity.com/stores/image15.png",
      "https://inphonity.com/stores/image16.png",
      "https://inphonity.com/stores/image17.png",
      "https://inphonity.com/stores/image18.png",
      "https://inphonity.com/stores/image19.png",
      "https://inphonity.com/stores/image20.png",
      "https://inphonity.com/stores/image21.png",
      "https://inphonity.com/stores/image22.png",
      "https://inphonity.com/stores/image23.png",
      "https://inphonity.com/stores/image24.png",
      "https://inphonity.com/stores/image25.png",
      "https://inphonity.com/stores/image26.png",
      "https://inphonity.com/stores/image27.png",
      "https://inphonity.com/stores/image28.png",
      "https://inphonity.com/stores/image29.png",
      "https://inphonity.com/stores/image30.png",
      "https://inphonity.com/stores/image31.png",
      "https://inphonity.com/stores/image32.png",
      "https://inphonity.com/stores/image33.png",
      "https://inphonity.com/stores/image34.png",
      "https://inphonity.com/stores/image35.png",
      "https://inphonity.com/stores/image36.png",
      "https://inphonity.com/stores/image37.png",
      "https://inphonity.com/stores/image38.png",
      "https://inphonity.com/stores/image39.png",
      "https://inphonity.com/stores/image40.png",
      "https://inphonity.com/stores/image41.png",
      "https://inphonity.com/stores/image42.png",
    ];
    ...
    const handlePayment = async (method: string, onlySaveRegister: boolean) => {
      ...
      const invitationId = atob(
        window.location.pathname.split("/")[2].replace("%3D", "=")
      );
        ...
        if (onlySaveRegister) {
          openModal(
            <div className="flex flex-col items-center justify-center h-full bg-black bg-modal-verde">
              <p
                className={`text-center text-3xl lg:text-3xl p-4 md:p-5 text-white`}
              >
                Da
                <span
              ...
              <p
                className={`text-center text-3xl lg:text-3xl p-4 md:p-5 text-white`}
              >
                Tu proceso se ha guardado, pronto recibirás un correo con un
                enlace para continuar con la firma del contrato.
              </p>
            </div>
          );
        }
    ...
    const registerCardPay = () => {
      ...
      if (!form.expirationDateMonth || !form.expirationDateYear) {
        errors = {
          ...
          expirationDateYearError:
            "Ingresa el año de expiración de la tarjeta.",
        };
      }
      if (!form.cvv) {
        errors = {
      ...
      OpenPay.setSandboxMode(
        process.env.NEXT_PUBLIC_OPENPAY_PRODUCTION === "false"
      );
                ...
                >
                  <div className={`grid grid-cols-12`}>
                    <div className="hidden md:flex md:col-span-2 justify-center relative">
                      {/* PlusDecoration */}
                      <PlusDecoration className="w-4 md:w-8 relative mx-auto" />
                      {/* PlusDecoration */}
                      <PlusDecoration
                    ...
                    <div className="col-span-12 md:col-span-8">
                      <h1
                        className={`text-center text-6xl lg:text-6xl p-4 md:p-5 text-white font-medium ajuste_centro`}
                      >
                        ¡Ups!
                      </h1>
                    ...
                    >
                      {/* PlusDecoration */}
                      <PlusDecoration className="w-9 md:w-12 lg:w-16 xl:w-20" />
                    </div>
                  </div>
                </div>
              );
              ...
              >
                <div className={`grid grid-cols-12`}>
                  ...
                  <div className="col-span-12 md:col-span-8">
                    ...
                    <div className={`flex mb-6 border-segmented-top pt-3`}>
                      <div className={`w-1/2 border-segmented-right`}>
                        <p className={`text-sm font-light p-4 text-left`}>
                          Pagado con
                          <br />
                          <br />
                          Fecha de pago
                      ...
                      <div className={`w-1/2`}>
                        <p className={`text-sm font-medium p-4 text-right`}>
                          {form.cardNumber.slice(0, 4) +
                            "**** **** " +
    ...
    const fetchMitIframe = async () => {
      try {
        ...
        const response = await fetch(
          `${api}/api/pre-register/${invitationId}/pay-with-mit`
        );
    ...
    const fetchTokuIframe = async (
      gateway: "card" | "transfer" | "paycash" | "codi"
    ) => {
      try {
        ...
        const api = process.env.NEXT_PUBLIC_API_URL || "http://127.0.0.1:8000";
        const response = await fetch(
          `${api}/api/pre-register/${invitationId}/pay-with-toku?gateway=${gateway}`
        );
        const data = await response.json();
        ...
        if (gateway === "paycash") {
          ...
          setTokuIframeCashReference(data.paycash.reference);
        }
      } catch (error) {
        console.error(error);
      }
    ...
    useEffect(() => {
      if (invitationData?.pre_registration) {
        handlePayment("card", false).then(() => {
          setMitIframe("");
          setTokuIframeCard("");
          setTokuIframeSpei("");
          setTokuIframeCash("");
          setTokuIframeCashReference("");
          setTokuIframeCodi("");
        });
      }
    }, [plan]);
    ...
    return (
      <div
        className="p-3 md:p-6 lg:p-9 xl:p-12 bg-white"
        id="PaymentFormSection"
      >
        {invitationData &&
        invitationData.pre_registration?.payment_status === "paid" ? (
          ...
          <>
            ...
            <header className="mb-10">
              <h3
                className={
                  "font-medium text-black text-center text-3xl sm:text-5xl mb-3"
                }
              >
            ...
            <div className="lg:container text-black font-medium px-6 md:px-8 lg:px-10 xl:px-12">
              {activeTab === "1" && (
                <div className={"grid grid-cols-12"} id={"payment-card"}>
                  ...
                  {mitIframe && (
                    <iframe
                      src={mitIframe}
                      className="col-span-12 h-[800px] border-0 w-full"
                    />
                  )}
                </div>
              )}
              ...
              {activeTab === "3" && (
                <div className={"grid grid-cols-12"} id={"payment-card"}>
                  <p className={`col-span-12 text-2xl mb-5`}>Pago via SPEI</p>
              ...
              {activeTab === "4" && (
                <div className={""} id={"payment-card"}>
                  <div className={`stores-filled`} id={`pdf-content`}>
                    <p className={`col-span-12 text-2xl mb-5`}>
                      Pago en efectivo
                    </p>

                    <p className={`col-span-12 text-xl mb-5`}>
                      Puedes realizar tu pago en efectivo en las siguientes
                    </p>
                    <p className={`col-span-12 text-xl mb-5`}>
                    ...
                    {tokuIframeCash && (
                      <div>
                        <div className={`stores-filled-reference`}>
                          <div className="col-span-12 text-3xl flex flex-col mt-10 mx-auto justify-between px-5 w-auto sm:w-[23.125rem] py-[3rem] h-[21.25rem] rounded-2xl border-2 border-black">
                            ...
                            <div className="flex justify-center">
                              <span className="font-medium text-4xl md:text-[3.125rem] my-[1.75rem] text-custom-blue">
                                Total a Pagar
                              </span>
                            </div>
                            <div className="flex justify-center pt-0 md:pt-4">
                              <span className="text-4xl md:text-[3.125rem]">
                                $
                                {formatNumber(
                                  Number(plan.price) + shippingCost
                                )}
                              </span>
                            </div>
                          </div>
              ...
              {activeTab === "5" && (
                <div className={"grid grid-cols-12"} id={"payment-card"}>
                  <p className={`col-span-12 text-2xl mb-5`}>Pago via CoDi</p>

                  {tokuIframeCodi && (
                    <iframe
                      src={tokuIframeCodi}
                      className="col-span-12 border-0 w-full"
                    />
                  )}
                </div>
              )}
